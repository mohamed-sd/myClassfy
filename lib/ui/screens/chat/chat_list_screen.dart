  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          backgroundColor: const Color.fromARGB(255, 200, 193, 172),
          appBar: UiUtils.buildAppBar(
            backgroundColor: const Color.fromARGB(255, 49, 21, 4),
            context,
            ...
            bottom: [
              ...
              Divider(
                height: 2, // Set height to 0 to make it full width
                thickness: 3, // Divider thickness
                color: Colors.amber.withValues(alpha: 0.2), // Divider color
              ),
            ],
          ),
          body: TabBarView(
