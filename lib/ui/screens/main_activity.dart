    ...
    return BottomAppBar(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: const Color.fromARGB(255, 49, 21, 4),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: <Widget>[
              if (currentTab == index) ...{
                UiUtils.getSvg(activeSvg, color: Colors.white),
              } else ...{
                UiUtils.getSvg(svgImage, color: Colors.amber),
              },
              CustomText(title,
                  fontWeight: FontWeight.w700,
                  textAlign: TextAlign.center,
                  color: currentTab == index ? Colors.white : Colors.amber),
            ],
          ),
        ),
      ),
